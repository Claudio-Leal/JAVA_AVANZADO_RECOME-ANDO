...
/*
 * Abaixo, a classe Minha exceção criada, sendo extendida para a classe "interna",...
 * Exception. Com isso, já vimos que todos os métodos da classe Exception serão carregados aqui.
